"""
═══════════════════════════════════════════════════════════════════════════════
  BROKER 10 API SERVER - TRADER CRISTÃO (Simple HTTP)
  Servidor HTTP simples - sem Flask, sem conflitos
  Conecta direto à Broker 10 via WebSocket e HTTP
═══════════════════════════════════════════════════════════════════════════════
"""
